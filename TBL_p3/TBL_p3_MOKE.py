...
Nk = N*N 
eta = 0.1 # eV
Area = np.linalg.norm(np.cross(L1,L2))
...
Kerr = -(Sxy-Syx)/(2.*Sxx*np.sqrt(4.j*np.pi*Sxx/E+1.)) #symmetrized

np.savez('./DATA.p3.npz',E=Eout,Sxx=Sxxout,Sxy=Sxyout,Syx=Syxout,Kerr=Kerr)
